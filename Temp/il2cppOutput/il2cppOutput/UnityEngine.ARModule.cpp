...
IL_0013:
	{
		...
		V_1 = (bool)((!(((RuntimeObject*)(Action_t591D2A86165F896B4B800BB5C25CE18672A55579 *)L_5) <= ((RuntimeObject*)(RuntimeObject *)NULL)))? 1 : 0);
		bool L_6 = V_1;
		if (!L_6)
		{
			goto IL_003a;
...
IL_0013:
	{
		ARBackgroundRenderer_RemoveCommandBuffersIfNeeded_m4FA080F4BC9F37D48028D0F09842B4684C7CE19D(__this, /*hidden argument*/NULL);
		Camera_t48B2B9ECB3CE6108A98BF949A1CECF0FE3421F34 * L_4 = ___value0;
		__this->set_m_Camera_0(L_4);
		Action_t591D2A86165F896B4B800BB5C25CE18672A55579 * L_5 = __this->get_backgroundRendererChanged_6();
		V_1 = (bool)((!(((RuntimeObject*)(Action_t591D2A86165F896B4B800BB5C25CE18672A55579 *)L_5) <= ((RuntimeObject*)(RuntimeObject *)NULL)))? 1 : 0);
		bool L_6 = V_1;
		if (!L_6)
...
IL_0010:
	{
		...
		__this->set_m_RenderMode_3(L_3);
		int32_t L_4 = __this->get_m_RenderMode_3();
		V_1 = L_4;
		int32_t L_5 = V_1;
		if (!L_5)
		{
...
IL_003b:
	{
		...
		Exception__ctor_m89BADFF36C3B170013878726E07729D51AA9FBE0(L_7, _stringLiteral52AEBE86CFA97FF26A8B7D3C3E5281F434DBCB8D, /*hidden argument*/NULL);
		IL2CPP_RAISE_MANAGED_EXCEPTION(L_7, ARBackgroundRenderer_set_mode_m4E412FC45FC8893846F16CADAB7CEF146AC0B820_RuntimeMethod_var);
	}

IL_0046:
	{
		Action_t591D2A86165F896B4B800BB5C25CE18672A55579 * L_8 = __this->get_backgroundRendererChanged_6();
		V_2 = (bool)((!(((RuntimeObject*)(Action_t591D2A86165F896B4B800BB5C25CE18672A55579 *)L_8) <= ((RuntimeObject*)(RuntimeObject *)NULL)))? 1 : 0);
		bool L_9 = V_2;
		if (!L_9)
		{
			goto IL_005f;
	...
	{
		Action_t591D2A86165F896B4B800BB5C25CE18672A55579 * L_10 = __this->get_backgroundRendererChanged_6();
		NullCheck(L_10);
...
IL_0018:
	{
		Camera_t48B2B9ECB3CE6108A98BF949A1CECF0FE3421F34 * L_3 = __this->get_m_Camera_0();
		IL2CPP_RUNTIME_CLASS_INIT(Object_tAE11E5E46CD5C37C9F3E8950C00CD8B45666A2D0_il2cpp_TypeInfo_var);
	...
	{
		Camera_t48B2B9ECB3CE6108A98BF949A1CECF0FE3421F34 * L_6 = __this->get_m_Camera_0();
		V_0 = L_6;
		goto IL_0039;
	}
...
IL_004d:
	{
		...
		NullCheck(L_11);
		int32_t L_12 = Camera_get_clearFlags_m1D02BA1ABD7310269F6121C58AF41DCDEF1E0266(L_11, /*hidden argument*/NULL);
		__this->set_m_CameraClearFlags_5(L_12);
		Camera_t48B2B9ECB3CE6108A98BF949A1CECF0FE3421F34 * L_13 = V_0;
		NullCheck(L_13);
		Camera_set_clearFlags_m805DFBD136AA3E1E46A2E61441965D174E87FE50(L_13, 3, /*hidden argument*/NULL);
		CommandBuffer_t70BF7D9D84C2AFA83559B45FAD5BEDA73DA617DD * L_14 = (CommandBuffer_t70BF7D9D84C2AFA83559B45FAD5BEDA73DA617DD *)il2cpp_codegen_object_new(CommandBuffer_t70BF7D9D84C2AFA83559B45FAD5BEDA73DA617DD_il2cpp_TypeInfo_var);
		CommandBuffer__ctor_m4394F7E41C9BB751E382A8CAFA38B19F69E03890(L_14, /*hidden argument*/NULL);
		__this->set_m_CommandBuffer_4(L_14);
		Texture_t387FE83BB848001FD06B14707AEA6D5A0F6A95F4 * L_15 = __this->get_m_BackgroundTexture_2();
		V_1 = L_15;
		Texture_t387FE83BB848001FD06B14707AEA6D5A0F6A95F4 * L_16 = V_1;
		IL2CPP_RUNTIME_CLASS_INIT(Object_tAE11E5E46CD5C37C9F3E8950C00CD8B45666A2D0_il2cpp_TypeInfo_var);
	...
	{
		Material_tF7DB3BF0C24DEC2FE0CB51E5DF5053D5223C8598 * L_19 = __this->get_m_BackgroundMaterial_1();
		NullCheck(L_19);
		bool L_20 = Material_HasProperty_m8611FACA6F9D9B2B5C3E92B6D93D2D514B443512(L_19, _stringLiteralC510EA100EEE1C261FE63B56E1F3390BFB85F481, /*hidden argument*/NULL);
		V_7 = L_20;
		bool L_21 = V_7;
		if (!L_21)
		{
	...
	}
	{
		...
		NullCheck(L_22);
		Texture_t387FE83BB848001FD06B14707AEA6D5A0F6A95F4 * L_23 = Material_GetTexture_mCD6B822EA19773B8D39368FF1A285E7B69043896(L_22, _stringLiteralC510EA100EEE1C261FE63B56E1F3390BFB85F481, /*hidden argument*/NULL);
		V_1 = L_23;
	}
...
IL_00a9:
	{
		...
		RenderTargetIdentifier_tB7480EE944FC70E0AB7D499DB17D119EB65B0F5B  L_26 = RenderTargetIdentifier_op_Implicit_m080A48CE8A898732E2554818DD3BF66004369D1B(2, /*hidden argument*/NULL);
		Material_tF7DB3BF0C24DEC2FE0CB51E5DF5053D5223C8598 * L_27 = __this->get_m_BackgroundMaterial_1();
		NullCheck(L_24);
		CommandBuffer_Blit_m0922EC09A8E32FBEE2CEE938328AB618128283E9(L_24, L_25, L_26, L_27, /*hidden argument*/NULL);
		Camera_t48B2B9ECB3CE6108A98BF949A1CECF0FE3421F34 * L_28 = V_0;
		CommandBuffer_t70BF7D9D84C2AFA83559B45FAD5BEDA73DA617DD * L_29 = __this->get_m_CommandBuffer_4();
		NullCheck(L_28);
		Camera_AddCommandBuffer_mA3A1341F6C15A1C9DEF1BA7471726238797880B7(L_28, ((int32_t)10), L_29, /*hidden argument*/NULL);
		Camera_t48B2B9ECB3CE6108A98BF949A1CECF0FE3421F34 * L_30 = V_0;
		CommandBuffer_t70BF7D9D84C2AFA83559B45FAD5BEDA73DA617DD * L_31 = __this->get_m_CommandBuffer_4();
		NullCheck(L_30);
		Camera_AddCommandBuffer_mA3A1341F6C15A1C9DEF1BA7471726238797880B7(L_30, 4, L_31, /*hidden argument*/NULL);
		V_3 = (bool)1;
		goto IL_00e3;
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void ARBackgroundRenderer_DisableARBackgroundRendering_mC40F92B5003445A310DF5AF59721E052A2E9DF30 (ARBackgroundRenderer_tF8843BC521430975DF4B9F191B174EB08F42672C * __this, const RuntimeMethod* method)
{
	...
	Camera_t48B2B9ECB3CE6108A98BF949A1CECF0FE3421F34 * G_B3_0 = NULL;
	{
		...
		V_1 = (bool)((((RuntimeObject*)(CommandBuffer_t70BF7D9D84C2AFA83559B45FAD5BEDA73DA617DD *)L_0) == ((RuntimeObject*)(RuntimeObject *)NULL))? 1 : 0);
		bool L_1 = V_1;
		if (!L_1)
		{
			goto IL_0010;
...
IL_0010:
	{
		...
		Camera_t48B2B9ECB3CE6108A98BF949A1CECF0FE3421F34 * L_3 = L_2;
		G_B3_0 = L_3;
		if (L_3)
		{
			G_B4_0 = L_3;
...
IL_002d:
	{
		Camera_t48B2B9ECB3CE6108A98BF949A1CECF0FE3421F34 * L_8 = V_0;
		int32_t L_9 = __this->get_m_CameraClearFlags_5();
		NullCheck(L_8);
		Camera_set_clearFlags_m805DFBD136AA3E1E46A2E61441965D174E87FE50(L_8, L_9, /*hidden argument*/NULL);
		...
		NullCheck(L_10);
		Camera_RemoveCommandBuffer_m323F15CA3AB7E38DB77C73930A9B517400403320(L_10, ((int32_t)10), L_11, /*hidden argument*/NULL);
		Camera_t48B2B9ECB3CE6108A98BF949A1CECF0FE3421F34 * L_12 = V_0;
		CommandBuffer_t70BF7D9D84C2AFA83559B45FAD5BEDA73DA617DD * L_13 = __this->get_m_CommandBuffer_4();
		NullCheck(L_12);
		Camera_RemoveCommandBuffer_m323F15CA3AB7E38DB77C73930A9B517400403320(L_12, 4, L_13, /*hidden argument*/NULL);
	}
